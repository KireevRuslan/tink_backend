...
INSERT INTO link_info.link(url, type, chat_id)
VALUES ('https://stackoverflow.com/questions/76040410/redis-master-slave-connection', 333);
INSERT INTO link_info.link(url, type, chat_id)
...
INSERT INTO link_info.link(url, type, chat_id)
VALUES ('https://github.com/KireevRuslan/tink_backend/TESTS', 'github', 99999);
