package domain.jooq.link_info.tables;
...
import domain.jooq.link_info.Keys;
import domain.jooq.link_info.LinkInfo;
...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The reference instance of <code>LINK_INFO.CHAT</code>
     */
    ...
    /**
     * The column <code>LINK_INFO.CHAT.CHAT_ID</code>.
     */
    ...
    /**
     * Create an aliased <code>LINK_INFO.CHAT</code> table reference
     */
    ...
    /**
     * Create a <code>LINK_INFO.CHAT</code> table reference
     */
    public Chat() {
